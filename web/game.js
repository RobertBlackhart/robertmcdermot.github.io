...
stringReplaceAllFuncUnchecked: function(receiver, pattern, onMatch, onNonMatch) {
  ...
  t1 = new H._AllMatchesIterator(t1._re, t1.__js_helper$_string, null);
  startIndex = 0;
  for (; t1.moveNext$0();) {
...
Asset: {"": "Object;_asset,loaded,_uri,name",
  load$0: function(_) {
    var t1, t2, c, loading, ext, line, audio, $arguments, t3, result;
    ...
    if (!this.loaded) {
      ...
      for (t1 = new H.ListIterator($.get$audioExtensions(), 2, 0, null), loading = false; t1.moveNext$0();) {
        ext = t1._dev$_current;
        if (J.endsWith$1$s(this._uri, C.JSString_methods.$add(".", ext))) {
          line = H.S(this.name) + ": test additional events";
          H.printToConsole(line);
          audio = W.AudioElement_AudioElement(null);
          t2 = C.EventStreamProvider_load0.forElement$1(audio);
          $arguments = H.substitute(t2.$as_EventStream, H.getRuntimeTypeInfo(t2));
          t3 = $arguments == null ? null : $arguments[0];
          t2 = new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new B.Asset_load_closure0()), t2._useCapture);
          t2.$builtinTypeInfo = [t3];
          t3 = t2._onData;
          if (t3 != null && t2._pauseCount <= 0)
            J.addEventListener$3$x(t2._html$_target, t2._eventType, t3, t2._useCapture);
          C.AudioElement_methods.addEventListener$2(audio, "canPlay", new B.Asset_load_closure1());
          t2 = C.EventStreamProvider_canplay.forElement$1(audio);
          $arguments = H.substitute(t2.$as_EventStream, H.getRuntimeTypeInfo(t2));
          t3 = $arguments == null ? null : $arguments[0];
          t2 = new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new B.Asset_load_closure2(this, c, audio)), t2._useCapture);
          t2.$builtinTypeInfo = [t3];
          t3 = t2._onData;
          if (t3 != null && t2._pauseCount <= 0)
            J.addEventListener$3$x(t2._html$_target, t2._eventType, t3, t2._useCapture);
      ...
      for (t1 = $.get$jsonExtensions(), t1 = new H.ListIterator(t1, t1.length, 0, null), loading = false; t1.moveNext$0();) {
        ...
        if (J.endsWith$1$s(this._uri, C.JSString_methods.$add(".", ext))) {
          ...
          t3 = $.Zone__current;
          t3.toString;
          result = new P._Future(0, t3, null, null, new B.Asset_load_closure4(this, c), null, P._registerErrorHandler(null, t3), null);
          result.$builtinTypeInfo = [null];
          t2._addListener$1(result);
          loading = true;
        }
...
Asset_load_closure1: {"": "Closure;",
  call$1: function($event) {
    P.print("canPlay added event");
  },
  $is_args1: true
},

Asset_load_closure2: {"": "Closure;this_2,c_3,audio_4",
  call$1: function(_) {
    var t1, t2;
    P.print("onCanplay");
    t1 = $.get$ASSET();
...
Asset_load_closure3: {"": "Closure;this_5,c_6",
...
Asset_load_closure4: {"": "Closure;this_7,c_8",
  call$1: function(string) {
    var t1, t2;
    t1 = $.get$ASSET();
    t2 = this.this_7;
...
HttpRequestEventTarget: {"": "EventTarget;",
  get$onLoad: function(receiver) {
...
Console: {"": "Object;",
  ...
  get$timeStamp: function(_receiver) {
    return new P.BoundClosure$i1(this, W.Console.prototype.timeStamp$1, _receiver, "timeStamp$1");
  },
  static: {
...
NumberFormat: {"": "Object;_negativePrefix,_positivePrefix,_negativeSuffix,_positiveSuffix,_groupingSize,_decimalSeparatorAlwaysShown,_useSignForPositiveExponent,_useExponentialNotation,maximumIntegerDigits,minimumIntegerDigits,maximumFractionDigits,minimumFractionDigits,minimumExponentDigits,_multiplier,_intl$_pattern,_locale,_symbols,_buffer,_maxInt,_zero",
  ...
  _formatFixed$1: function(number) {
    ...
    if (typeof 1 === "number" && intValue > this._maxInt) {
      ...
      for (t1 = C.JSInt_methods.toInt$0(howManyDigitsTooBig), t1 = new H.ListIterator(P.List_List(t1, null), t1, 0, null); t1.moveNext$0();) {
  ...
  _formatFractionPart$1: function(fractionPart) {
    ...
    t1 = this._zero;
    t2 = new J._CodeUnits(fractionPart)._string;
    while (true) {
