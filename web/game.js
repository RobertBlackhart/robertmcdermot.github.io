...
["coUclient", "../../web/main.dart", , B, {
  ...
  Chat: {
    ...
    init$0: function() {
      ...
      var t1 = document.querySelector("#ChatSettingsIcon");
      t1.toString;
      t1 = C.EventStreamProvider_click.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Chat_init_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = document.querySelector("#MobileChatSettingsIcon");
      t1.toString;
      t1 = C.EventStreamProvider_click.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Chat_init_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  Input: {
    ...
    init$0: function() {
      var t1, volumeSlider, chatInputs, joystick;
      $.get$game()._pointerLock.lockOnClick = false;
      t1 = document.querySelector("#ConsoleGlyph");
      t1.toString;
      t1 = C.EventStreamProvider_click.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = document.querySelector("#CloseConsole");
      t1.toString;
      t1 = C.EventStreamProvider_click.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      ...
      C.EventStreamProvider_click._forElementList$1(W._FrozenElementList$_wrap(document.querySelectorAll(".FullscreenResetGlyph"), null)).listen$1(new B.Input_init_closure2());
      ...
      t1.toString;
      t1 = C.EventStreamProvider_click.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure4()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      volumeSlider = document.querySelector("#VolumeSlider");
      volumeSlider.toString;
      t1 = C.EventStreamProvider_change.forElement$1(volumeSlider);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure5(volumeSlider)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      ...
      H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new B.Input_init_closure10(this, joystick));
      t1 = joystick._releaseController;
      H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new B.Input_init_closure11(this));
      ...
      t1.toString;
      t1 = C.EventStreamProvider_touchstart.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure14()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = document.querySelector("#BButton");
      t1.toString;
      t1 = C.EventStreamProvider_touchend.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure15()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = document.querySelector("#ChatBubble");
      t1.toString;
      t1 = C.EventStreamProvider_click.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure16()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = document.querySelector("#BackFromChannelSelector");
      t1.toString;
      t1 = C.EventStreamProvider_click.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure17()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = document.querySelector("#BackFromChat");
      t1.toString;
      t1 = C.EventStreamProvider_click.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure18()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = W._FrozenElementList$_wrap(document.querySelectorAll(".ChannelName"), null);
      t1.forEach$1(t1, new B.Input_init_closure19());
      t1 = document.querySelector("#SendButton");
      t1.toString;
      t1 = C.EventStreamProvider_click.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure20()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      ...
      t1.toString;
      t1 = C.EventStreamProvider_click.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure21()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = document.body;
      t1.toString;
      t1 = C.EventStreamProvider_contextmenu.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Input_init_closure22(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      $.playerInput = this;
    },
  ...
  Input_init_closure15: {
    "": "Closure:3;",
    call$1: function(_) {
    }
  },
  Input_init_closure16: {
    "": "Closure:3;",
    call$1: function(_) {
  ...
  Street: {
    ...
    render$0: function() {
      ...
      if (typeof t1 !== "number")
        return t1.$div();
      for (t5 = W._FrozenElementList$_wrap(t5.querySelectorAll("canvas"), null), t5 = t5.get$iterator(t5), t6 = -(t2 / (t4 - t6)), t7 = -(t1 / (t3 - t7)); t5.moveNext$0();) {
        canvas = t5._current;
        ...
        if (t1.get$id(canvas) === "gradient") {
          ...
          if (typeof t3 !== "number")
            return H.iae(t3);
          J.set$top$x(t2, C.JSNumber_methods.toString$0((t1 - t3) * t7) + "px");
        } else {
          ...
          J.set$left$x(t1.get$style(canvas), C.JSNumber_methods.toString$0((t2 - t3) * t6) + "px");
          J.set$top$x(t1.get$style(canvas), C.JSNumber_methods.toString$0((t4 - t8) * t7) + "px");
        }
      }
    },
