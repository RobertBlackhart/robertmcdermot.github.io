...
["coUclient", "../../web/main.dart", , B, {
  ...
  gameLoop: [function(delta) {
    ...
    if ($.showFps) {
      ...
      if (C.JSNumber_methods.compareTo$1(t1, $.get$lastUpdate().millisecondsSinceEpoch) !== 0) {
        t1 = C.JSNumber_methods._tdivFast$1(P.Duration$(0, 0, 0, t1 - $.get$lastUpdate().millisecondsSinceEpoch, 0, 0)._duration, 1000);
        t2 = $.fps;
  ...
  Animation_load_closure: {
    ...
    call$1: function(_) {
      ...
      t2 = t1.animationName;
      if (t2 === "stillframe") {
        t1.width = J.$tdiv$n(width, 15);
        t1.height = height;
        endPos = J.$sub$n(width, J.$tdiv$n(width, 15));
      ...
      if (t2 === "base") {
        t1.width = J.$tdiv$n(width, 15);
        t1.height = height;
        endPos0 = J.$sub$n(width, J.$tdiv$n(width, 15) * 3);
        t3 = document.styleSheets;
        if (0 >= t3.length)
          return H.ioore(t3, 0);
      ...
      if (t2 === "jump") {
        t2 = J.$tdiv$n(width, 33);
        t1.width = t2;
        t1.height = height;
        frame32 = J.$sub$n(width, t2);
  ...
  Player_update_closure: {
    ...
    call$1: function(element) {
      this.this_0.checkCollision$2(this.avatarRect_1, element);
    }
  },
  Player_checkCollision_closure: {
    "^": "Closure:6;element_0",
    call$0: function() {
      var t1 = C.JSString_methods.$add("#qq", this.element_0.id);
      return J.get$classes$x(document.querySelector(t1)).remove$1(0, "circleExpand");
    }
  },
  Player_checkCollision_closure0: {
    "^": "Closure:6;element_1",
    call$0: function() {
      var t1 = C.JSString_methods.$add("#q", this.element_1.id);
      return J.get$classes$x(document.querySelector(t1)).remove$1(0, "circleExpand");
    }
  },
  Camera: {
...
["dart.dom.html", "dart:html", , W, {
  ...
  CssStyleDeclarationBase: {
    ...
    get$transform: function(receiver) {
      return this.getPropertyValue$1(receiver, P.Device_cssPrefix() + "transform");
    },
