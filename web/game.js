...
["coUclient", "../../web/main.dart", , B, {
  ...
  setVolume: [function(value) {
    ...
    if (intvalue != null) {
      ...
      H.interceptedTypeCast(document.querySelector("#rangevalue"), "$isOutputElement").value = value;
      t1 = $.get$ui().currentSong;
      if (t1 != null)
  ...
  TabContent: {
    ...
    _addmessage$1: function(map) {
      ...
      if (J.$eq(t1.$index(map, "channel"), "Local Chat") && J.$eq(t1.$index(map, "username"), $.get$chat().username) && t1.$index(map, "statusMessage") == null) {
        ...
        $.CurrentPlayer.chatBubble = B.ChatBubble$(t1.$index(map, "message"));
      }
    },
